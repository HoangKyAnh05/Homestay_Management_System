  ...
  return (
    <aside className={`floating-contact-widget ${mobileExpanded ? 'is-expanded' : ''}`} aria-label="Liên hệ nhanh Lá Đỏ Homestay">
      ...
      <div className="fcw-buttons-list">
        ...
        <a
          href="/explore"
          className="fcw-btn fcw-btn--explore"
        ...
        >
          ...
          <div className="fcw-pulse-ring fcw-pulse-ring--explore fcw-pulse-ring--delay"></div>
        ...
        >
          ...
          <div className="fcw-pulse-ring fcw-pulse-ring--facebook fcw-pulse-ring--delay"></div>
        ...
        >
          ...
          <div className="fcw-pulse-ring fcw-pulse-ring--zalo fcw-pulse-ring--delay"></div>
        ...
        >
          <div className="fcw-pulse-ring fcw-pulse-ring--phone"></div>
          <div className="fcw-pulse-ring fcw-pulse-ring--phone fcw-pulse-ring--delay"></div>
