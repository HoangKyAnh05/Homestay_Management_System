...
public class SocialOAuthSession {
    ...
    public Long getConnectedAccountId() { return connectedAccountId; }
    public void setConnectedAccountId(Long connectedAccountId) { this.connectedAccountId = connectedAccountId; }
