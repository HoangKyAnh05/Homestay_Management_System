    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/admin/marketing/comments/suggest-reply").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/admin/marketing/comments/sync-scanned").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/admin/marketing/comments/all-synced").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/admin/marketing/comments/reply-synced").permitAll()
